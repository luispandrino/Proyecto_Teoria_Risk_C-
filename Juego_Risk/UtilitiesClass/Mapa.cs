...
namespace Juego_Risk.UtilitiesClass
{
    public class Mapa
    {
        ...
        public Mapa()
        {
            ...
            EUA_Norte.AgregarInfo("EUA Norte", 0, 3, 2, 0, 0, 0, 16);
            EUA_Occidental.AgregarInfo("EUA Occidental", 0, 3, 2, 0, 0, 0, 17);
            EUA_sur.AgregarInfo("EUA sur", 0, 3, 2, 0, 0, 0, 18);
            Gran_Bretaña.AgregarInfo("Gran Bretaña", 0, 3, 3, 0, 0, 0, 19);
            Groenlandia.AgregarInfo("Groenlandia", 0, 3, 3, 0, 0, 0, 20);
            India.AgregarInfo("India", 0, 3, 2, 0, 0, 0, 21);
            Indonesia.AgregarInfo("Indonesia", 0, 3, 3, 0, 0, 0, 22);
            Irkutsk.AgregarInfo("Irktsk", 0, 3, 1, 0, 0, 0, 23);
            Islanlandia.AgregarInfo("Islandia", 0, 3, 3, 0, 0, 0, 24);
            Japón.AgregarInfo("Japón", 0, 3, 2, 0, 0, 0, 25);
            Kamchatka.AgregarInfo("Kamchatka", 0, 3, 3, 0, 0, 0, 26);
            Madagascar.AgregarInfo("Madagascar", 0, 3, 3, 0, 0, 0, 27);
            Mongolia.AgregarInfo("Mongolia", 0, 3, 1, 0, 0, 0, 28);
            Nueva_Guienea.AgregarInfo("Nueva Guinea", 0, 3, 2, 0, 0, 0, 29);
            Occidental_USA.AgregarInfo("Occidental USA", 0, 3, 1, 0, 0, 0, 30);
            Ontario.AgregarInfo("Ontario", 0, 3, 2, 0, 0, 0, 31);
            Oriente_Medio.AgregarInfo("Oriente Medio", 0, 3, 2, 0, 0, 0, 32);
            Perú.AgregarInfo("Perú", 0, 3, 1, 0, 0, 0, 33);
            Quebec.AgregarInfo("Quebec", 0, 3, 2, 0, 0, 0, 34);
            Siam.AgregarInfo("Siam", 0, 3, 2, 0, 0, 0, 35);
            Siberia.AgregarInfo("Siberia", 0, 3, 1, 0, 0, 0, 36);
            Sudáfrica.AgregarInfo("Sudáfrica", 0, 3, 2, 0, 0, 0, 37);
            Terrirorio_del_Noroeste.AgregarInfo("Territorio del Noroeste", 0, 3, 2, 0, 0, 0, 38);
            Ucrania.AgregarInfo("Ucrania", 0, 3, 1, 0, 0, 0, 39);
            Ural.AgregarInfo("Ural", 0, 3, 1, 0, 0, 0, 40);
            Venezuela.AgregarInfo("Venezuela", 0, 3, 1, 0, 0, 0, 41);
            Yakutsk.AgregarInfo("Yakutsk", 0, 3, 1, 0, 0, 0, 42);
